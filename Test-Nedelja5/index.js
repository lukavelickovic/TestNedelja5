...
document.getElementById('#btn-all').array.forEach(element => { addEventListener('click',document.createElement)
    
});
const isValid = narudzbina => narudzbina.name != '' && narudzbina.kupac.lenght == 4
if(isValid(narudzbina)){
    narudzbina.push(narudzbina)
}
else{
    console.log('Nepostojeci unos')
}
